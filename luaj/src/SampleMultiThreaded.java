...
public class SampleMultiThreaded {
	...
	public static void main(final String[] args) throws IOException {
		final String script1 = args.length > 0? args[0]: "nsieve.lua";//"test/lua/perf/nsieve.lua";
		final String script2 = args.length > 1? args[1]: "binarytrees.lua";//"test/lua/perf/binarytrees.lua";
		try {
